...
int der_encode_asn1_identifier(ltc_asn1_list *id, unsigned char *out, unsigned long *outlen);
int der_decode_asn1_identifier(const unsigned char *in, unsigned long *inlen, ltc_asn1_list *id);
int der_length_asn1_identifier(ltc_asn1_list *id, unsigned long *idlen);
...
/* Custom-types set by LTC_SET_ASN1_IDENTIFIER */
int der_encode_custom_type(ltc_asn1_list *root,
                           unsigned char *out,  unsigned long *outlen);

int der_decode_custom_type(const unsigned char *in, unsigned long  inlen,
                           ltc_asn1_list *root);

int der_length_custom_type(ltc_asn1_list *root, unsigned long *outlen, unsigned long *payloadlen);
